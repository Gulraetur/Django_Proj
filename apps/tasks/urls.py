...
from .views import TaskListCreateView, TaskDetailView, DeliverTaskView, AcceptTaskView, RevisionTaskView, TaskMaterialsView, PublishTaskView
...
urlpatterns = [
    ...
    path('<int:task_id>/publish/', PublishTaskView.as_view(), name='publish'),
]